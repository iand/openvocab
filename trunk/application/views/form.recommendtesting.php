...
<html lang="en">
  <head>
    ...
    <?php
      ...
      echo "<title>Recommend " . htmlspecialchars($title) . " to be promoted to 'testing' status</title>" . "\n";
    ?>
  ...
  <body>
    ...
    <h2 class="bottom">Recommend <?php echo htmlspecialchars($model->label . ' (' . $model->get_qname() . ')') ; ?> to be promoted to 'testing' status</h2>
    <hr>
      ...
      <?php if (isset($success)) { echo "<div class=\"success\">$success</div>"; } ?>
        ...
        <form action="/forms/rectesting" method="POST">
          <p>
            <label for="reason">Enter a reason for promoting to 'testing' status: </label>
