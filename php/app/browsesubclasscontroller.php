...
class BrowseSubClassController extends k_Controller
{
  ...
  select ?r1 ?r2   
  where {
    ?r1 rdfs:subClassOf ?r2 ; rdfs:isDefinedBy <" . htmlspecialchars(VOCAB_SCHEMA) . "> .
 }";
  ...
  function GET() {
    $vars = array(  );
    return $this->render("templates/browsesubclasses.tpl.php", $vars);
  }
}
?>
